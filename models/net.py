...
class FeatureNet(nn.Module):
    ...
    def forward(self, x):
       ...
       # for x in img:
        ...
        # normal feature and add position
        #conv1 = conv1 - torch.min(conv1)
        #conv1 = feature_add_position(conv1,1,self.feature_channels)
...
class AdaptMVSNet(nn.Module):
    ...
    def forward(self, imgs,proj_matrices, depth_min, depth_max) : #imgs,proj_matrices, depth_min, depth_max
        ...
        timef_1 = time.time()
        # imgs_0 = list(imgs_0)
        # #torch.onnx.export(self.feature, imgs_0,"./checkpoints/feature.onnx",opset_version=14,verbose=False)
        # features0,features1,features2,features3,features4 = self.feature(imgs_0)
        # features.append(features0)
        ...
        # torch.onnx.export(self.patch, (src_features,ref_feature ,depth_min,proj_matrices,depth_max),
