...
compute_normals_0 = NormalGenerator(height=512,width=640)
compute_normals_1 = NormalGenerator(height=int(512/2),width=int(640/2))
compute_normals_2 = NormalGenerator(height=int(512/4),width=int(640/4))
compute_normals_3 = NormalGenerator(height=int(512/8),width=int(640/8))
